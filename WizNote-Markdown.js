;(function() {
    ...
    */
    ...
    function WizInitMarkdown(doc) {
		...
		WizMDAppendCssSrc(doc, "tree\\zTreeStyle.css");
...
//            var isMathJax = isMarkdownAndMathJax;
            ...
            if (isMathJax) {
           	...
           	WizMDAppendScriptSrc(doc, 'HEAD', "text/javascript", "tree\\jquery.ztree.core-3.5.min.js");
    		WizMDAppendScriptSrc(doc, 'HEAD', "text/javascript", "tree\\ztree_toc.js");
        };
    }
})();
