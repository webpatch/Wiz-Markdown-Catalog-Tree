;(function() {
    ...
    function ParseContent(objHtmDoc) {
        ...
        body.innerHTML ='<div class="sider" id="sider" ><div id="toolbar" ><a href="javascript:void(0);" id="hidePanel" title="隐藏"></a><span id="showButtons" class=""><a href="javascript:void(0);" id="expendAll" title="全部展开"></a><a href="javascript:void(0);" id="collapseAll" title="全部收缩"></a></span></div><ul id="tree" class="ztree" ></ul></div><div id="myContent" class="myContent_max">'+text+'</div>';
        prettyPrint();
        if (IsMathJax) {
            MathJax.Hub.Queue(
